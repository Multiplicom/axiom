...
var grammar = {
    ...
    {"name": "str$ebnf$3", "symbols": [/[\w]/]},
    {"name": "str$ebnf$3", "symbols": ["str$ebnf$3", /[\w]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "str", "symbols": ["str$ebnf$3"], "postprocess": function(d) { return d[0].join('') }},
